...
/*
[6:0]: SPI clock speed
[7]: SPI function mode, p_csn, p_scl, p_sda and p_sdo function as SPI if 1
*/
...
/*
[0]: inverse SPI clock output
[1]: dat delay half clk
 */
...
/* reg_adc_chn:
[4:0]: Analog input selection bit for Misc
...FLD_ADC_CHN...
[6:5]: Differential analog input selection bits for Misc
	00: single-end
	01: D[5] as inverting input
	10: C[3] as inverting input
	11: PGA left channel as inverting input
[7]: data format setting during Misc period
	0: unsigned
...
[6:5]: Differential analog input selection bits for L
[7]: data format setting during L period Refer to 0x2c
 */
...
/*
 Period = adc_period_chn0 * system clocks
 */
#define reg_adc_period_chn0		REG_ADDR16(0x30)
/*
 ADC auto channel 1 (L)& 2 period
Period = adc_period_chn12 * 16 system clocks
 */
...
enum{
	CLK_SEL_HSDIV = 0,	// hs divider clk (0x66[4:0])
	CLK_SEL_RC32M = 1,	// 32M clock from RC
...
enum{
	...
	FHS_SEL_RC = 2,		// 32M clock from osc
...
#define reg_irq_src4			REG_ADDR8(0x64b)
enum{
